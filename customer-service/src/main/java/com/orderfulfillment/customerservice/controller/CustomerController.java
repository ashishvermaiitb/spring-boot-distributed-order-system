...
@Tag(name = "Customer Management", description = "APIs for managing customers in the order fulfillment system")
public class CustomerController {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "409", description = "Customer already exists with email")
    })
